...
- `patent-specific-embodiment-drafting`（说明书具体实施方式撰写）：先原样复述对应权利要求/步骤的技术方案，再用"具体而言，"过渡，按原有顺序逐条展开每个技术特征的原理和具体实施方式，不遗漏、不夹带新特征。
- `patent-drawings-description-drafting`（说明书附图说明撰写）：附图说明只能依据交底书已有附图撰写，不能凭空编造新图；核心发明点缺少对应附图时，写完后要单独提醒撰写人向发明人申请补充；方法类发明第一张图必须是方法流程图。
